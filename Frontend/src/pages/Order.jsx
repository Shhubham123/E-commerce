                        ...
                        <div className='w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative'>
                            ...
                            <div className='flex items-start justify-center flex-col gap-[5px]'>
                                ...
                                <div className='flex items-center gap-[8px] md:gap-[20px]' >
                                    <p className='md:text-[18px] text-[10px] text-[#aaf4e7]'>{currency}{item.price}</p>
                                    <p className='md:text-[18px] text-[10px] text-[#aaf4e7]'>Quantity:{item.quantity}</p>
                                    <p className='md:text-[18px] text-[10px] text-[#aaf4e7]'>Size:{item.size}</p>
                                </div>
                                ...
                                <div className='flex items-center'>
                                    <p className='md:text-[16px] text-[12px] text-[#aaf4e7] '>
                                        Payment Method:<span className='text-[#e4fbff] pl-[10px] md:text-[16px] text-[11px]'>{item.paymentMethod}</span>
                                    </p>
                                </div>
